...
<html>
  <head>
	...
	<script type="text/javascript" src="js/comm/checkDateTimeValid.js"></script>
  ...
  <body>
    <form  action="bado" method="post" id="myform">
      <div>
        <table>
          <tr>
            <td>任务编号:</td>
		...
		<BR>
		<input type="button" value="确认添加" onclick="mysubmit()"/>
