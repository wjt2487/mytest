...
public class BoxModifyOneDataServlet extends HttpServlet {
	 ...
	 */
	public BoxModifyOneDataServlet() {
		super();
	}
...
//		PrintWriter pw=response.getWriter();
		...
		try {
			boolean b=boxService.updateOneData(histablename, tagId, btime, tvalue);
			if(b){
