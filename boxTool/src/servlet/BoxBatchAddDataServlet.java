...
public class BoxBatchAddDataServlet extends HttpServlet {
...
//		PrintWriter pw=response.getWriter();
		...
		if(taskId == null || tagId==null ||btime==null ||etime==null ||(max-min-1==0) ){
		...
		try {
			...
			b = bdel&&bbin;
			if(b){
				System.out.println("添加"+btime+"到"+etime+"数据成功");
				response.sendRedirect("success.html");
			}else {
				System.out.println("添加"+btime+"到"+etime+"数据失败");
				response.sendRedirect("fail.html");
			}
